...
export default function AnalyticsPage() {
	...
	return (
		<div>
			...
			<> / </>
			<a href="/dashboard/analytics" className="text-2xl font-semibold text-blue-600 underline dark:text-blue-500 hover:no-underline cursor-pointer">analytics</a>
			<p className="text-gray-600 dark:text-gray-300 mt-2">
				reports area
			</p>

			<div className="bg-gray-100 dark:bg-gray-900 p-4 rounded-lg mt-4">
				graphs or other received info here
			</div>
		</div>
	);
}
